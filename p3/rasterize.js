...
function loadModels() {
    ...
    function makeSphere(numLongSteps) {
        ...
        try {
            ...
            return({vertices:sphereVertices, normals:sphereNormals, triangles:sphereTriangles, textureUVs:sphereTextureUVs});
        } // end try
    ...
    try {
        if (inputTriangles == String.null)
            ...
            for (var whichSet=0; whichSet<numTriangleSets; whichSet++) { // for each tri set
				...
				textureBuffers[whichSet] = gl.createBuffer(); // init empty webgl set vertex coord buffer
            ...
            if (inputSpheres == String.null)
                ...
                // send the sphere vertex coords , texture coords and normals to webGL
                ...
                gl.bufferData(gl.ARRAY_BUFFER,new Float32Array(oneSphere.textureUVs),gl.STATIC_DRAW); // data in
...
function setupShaders() {
    ...
    var vShaderCode = `
		...
		attribute vec2 aTextureCoord; // texture coord
